...
class RegisterForm extends Component {
  ...
  _onPress() {
    const Username = this.state.TextInputUserName;
    const Email = this.state.TextInputEmail;
    const Password = this.state.TextInputPassword;
  ...
  render() {
    ...
    return (
      ...
      <View >
      <Text left caption style={{fontSize:25,paddingBottom:h(1),paddingLeft:w(5),fontWeight:'bold',color:'#3465d9'}}>Kayıt Ol</Text>
      </View>
